...
card GetMessage, then: SendMessage do
  ...
  # This changes between here and the OG Whatsapp Flow ("sms" instead of "whatsapp") - this will change to channel=sms
  page =
    get(
...
card ScheduleNextMessage do
  ...
  run_stack("8bbc9860-7885-450c-b40d-98845a4464c6")
end
